...
function Node(weave, parentNode, data) {
  ...
  this.fields = attrib || {};
  if(this.hidden || this.parentNode.root) {
    this.urlName = '';
  }
...
Node.prototype.isHidden = function isHidden() {
  if(this.hidden) return true;
  return this.parentNode &&
         this.parentNode.isHidden &&
         this.parentNode.isHidden();
}

Node.prototype.url = function url(closest) {
  if(!closest && this.isHidden()) return undefined;
  if(!this.parentNode || this.parentNode.root) { return '/'; }
